...
class CustomThemeData {
  static final ThemeData light = ThemeData(
    ...
    textTheme: textTheme.copyWith(
        displaySmall: textTheme.displaySmall?.copyWith(color: Colors.black)),
  ...
  static final ThemeData dark = ThemeData(
    textTheme: textTheme.copyWith(
      displaySmall: textTheme.displaySmall?.copyWith(color: Colors.deepOrange),
    ),
    scaffoldBackgroundColor: const Color.fromRGBO(31, 31, 31, 1),
    appBarTheme: AppBarTheme(
        backgroundColor: const Color.fromRGBO(51, 51, 51, 1),
        titleTextStyle: textTheme.headlineSmall?.copyWith(color: Colors.deepOrange),
