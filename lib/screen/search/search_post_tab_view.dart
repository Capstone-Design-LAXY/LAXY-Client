...
class SearchPostTabView extends StatefulWidget {
  ...
  @override
  State<SearchPostTabView> createState() => _SearchPostTabViewState();
}

class _SearchPostTabViewState extends State<SearchPostTabView> {
  ...
  void initState() {
    ...
    postData = fetchSearchPostData(widget.searchTerm);
